import pickle
from .generate_roi_features import generate_features, load_model
import json
...
def read_captions_mscoco(data_dir, mode):
    ...
    for data in image_data['annotations']:
        ...
        caption = ' '.join(word_tokenize(data['caption'].lower()))
...
def read_image_list_flickr(mode='train', data_dir='../dataset/'):
    ...
    image_ids_list = ['72218201_e0e9c7d65b.jpg', '86542183_5e312ae4d4.jpg', '99171998_7cc800ceef.jpg',
                      '101669240_b2d3e7f17b.jpg', '102455176_5f8ead62d5.jpg', '108898978_7713be88fc.jpg',
                      '115684808_cb01227802.jpg', '116409198_0fe0c94f3b.jpg']
    #image_ids_list = ['72218201_e0e9c7d65b.jpg', '99171998_7cc800ceef.jpg']
    return image_ids_list
    #return images
...
if __name__ == "__main__":
    data_dir="../dataset/"
    image_ids_list = read_image_list(dataset='flickr8k', mode='train', data_dir=data_dir)
